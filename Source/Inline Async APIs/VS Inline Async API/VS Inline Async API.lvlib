...
<Library LVVersion="15008000">
	...
	<Item Name="Error Handling Process" Type="Folder">
		<Item Name="Display and Log Process.vi" Type="VI" URL="../Display and Log Process.vi"/>
	</Item>
	<Item Name="Process.lvclass" Type="LVClass" URL="../Process/Process.lvclass"/>
	<Item Name="VS Inline Async API.lvclass" Type="LVClass" URL="../VS Inline Async API.lvclass"/>
</Library>
